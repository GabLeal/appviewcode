...
final class LoginViewController: UIViewController{
    ...
    private lazy var arrowBack: UIImageView = {
        ...
        let tap = UITapGestureRecognizer(target: self, action: #selector(backNavigation))
    ...
    private lazy var textFieldUsername: CustomTextField = {
        ...
        textField.addTarget(self, action: #selector(validarTeste), for: .editingChanged)
    ...
    override func viewDidLoad() {
        self.view.backgroundColor = UIColor(rgb: 0xFF002CC2)
    ...
    private func addSubViews(){
        self.view.addSubview(viewCircleFirst)
        self.view.addSubview(viewCircleSecond)
    ...
    private func addConstraintsViewCirle(){
        NSLayoutConstraint.activate([
            ...
            viewCircleFirst.topAnchor.constraint(equalTo: view.topAnchor, constant: -55),
            viewCircleFirst.trailingAnchor.constraint(equalTo: view.trailingAnchor),
            
            viewCircleSecond.widthAnchor.constraint(equalToConstant: 150),
            viewCircleSecond.heightAnchor.constraint(equalToConstant: 150),
            viewCircleSecond.topAnchor.constraint(equalTo: view.topAnchor),
            viewCircleSecond.trailingAnchor.constraint(equalTo: view.trailingAnchor,constant: 75),
    ...
    private func addConstraintsBackButton(){
        NSLayoutConstraint.activate([
            ...
            arrowBack.topAnchor.constraint(equalTo: view.topAnchor, constant: 100),
            arrowBack.leadingAnchor.constraint(equalTo: view.leadingAnchor, constant: 30),
        ])
    }
    ...
    private func addConstraintsLabelSignIn(){
        NSLayoutConstraint.activate([
            labelSignIn.leadingAnchor.constraint(equalTo: view.leadingAnchor, constant: 30),
